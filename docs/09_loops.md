...
// en
var ketQua = loop {
    break giaTri   // trả về giá trị khi thoát
}
...
// en
var mut i = 0
var viTri = loop i < danhSach.size {
...
// vi
biến khả_biến i = 0
biến viTri = lặp i < danhSach.size {
    nếu (danhSach[i] == mucTieu) thì {
        dừng i
    }
    i = i + 1
    dừng -1
...
```text
duyệt phanTu của danhSach {
    nếu (phanTu == boQua) thì {
