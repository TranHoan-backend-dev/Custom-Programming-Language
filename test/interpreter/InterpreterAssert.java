...
/**
 * Lớp hỗ trợ kiểm thử tự động cho Interpreter, cung cấp các hàm so sánh (assertion) cơ bản.
 * Nếu điều kiện kiểm tra thất bại, một lỗi {@link AssertionError} sẽ được ném ra để đánh dấu ca kiểm thử không thành công.
 * 
 * @author XUAN HOAN
 */
public class InterpreterAssert {
    ...
    /**
     * Kiểm tra một điều kiện logic phải có giá trị là sai (false).
     * Nếu điều kiện có giá trị là đúng (true), phương thức sẽ ném ra {@link AssertionError}.
     * 
     * @param condition Điều kiện logic cần kiểm tra
     * @throws AssertionError nếu điều kiện là đúng (true)
     */
    public static void assertFalse(boolean condition) {
        if (condition) {
            throw new AssertionError("Kỳ vọng điều kiện là SAI nhưng thực tế là ĐÚNG");
        }
    }
}
